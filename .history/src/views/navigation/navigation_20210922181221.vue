      ...
      <div style="margin-top: 10px">
        <el-form :model="swiper" ref="ruleForm" class="demo-ruleForm">
          <el-form-item label="图片地址:" prop="img">
            ...
            <div v-if="swiper.url">
              <img :src="swiper.url" class="imgBox" />
            </div>
          </el-form-item>
          <el-form-item label="导航标题" prop="path">
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column label="图片">
          <template #default="scope">
            <img :src="scope.row.url" class="img" />
          </template>
        </el-table-column>
        <el-table-column prop="url" label="路径" width="800px">
        </el-table-column>
        <el-table-column prop="title" label="标题" width="150px">
        </el-table-column>
        <el-table-column fixed="right" label="是否显示" width="120px">
          <template #default="scope">
            <el-switch
