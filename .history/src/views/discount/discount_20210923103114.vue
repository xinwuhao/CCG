<template>
  <div>
    <div class="searchBox">
      ...
      <el-button type="primary" @click="ON">添加优惠券</el-button>
    </div>
    <!-- 添加优惠券弹出层 -->
    <el-dialog
      title="添加优惠券"
      ...
      <div style="margin-top: 10px">
        <el-form :model="swiper" ref="ruleForm" class="demo-ruleForm">
          ...
          <el-form-item label="使用门槛：" prop="threshold">
            <el-input v-model="swiper.threshold" class="inpud"></el-input>
          </el-form-item>
          <el-form-item label="优惠金额：" prop="amount">
            <el-input v-model="swiper.amount" class="inpud"></el-input>
          </el-form-item>
          <el-form-item label="开始时间：" prop="start_time">
            <el-input v-model="swiper.start_time" class="inpud"></el-input>
          </el-form-item>
          <el-form-item label="结束时间：" prop="end_time">
            <el-input v-model="swiper.end_time" class="inpud"></el-input>
          </el-form-item>
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column label="开始时间">
          <template #default="scope">
            <img :src="scope.row.start_time" class="imgBox" />
          </template>
        </el-table-column>
        <el-table-column label="结束时间">
          <template #default="scope">
            <img :src="scope.row.end_time" class="imgBox" />
          </template>
        </el-table-column>
...
let getlong = () => {
  ...
  //       amount:"swiper.value.name",
  //       threshold: "swiper.value.name",
  //       start_time:"swiper.value.name",
  //       end_time: "swiper.value.name",
  //       number: "swiper.value.name",
  //       isShow: true,
  //     })
  //     .then((res: any) => {
  //       if (res.code == 200) {
