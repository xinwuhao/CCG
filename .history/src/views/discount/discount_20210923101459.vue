  ...
  <div>
    ...
    >
      <div style="margin-top: 10px">
        <el-form :model="swiper" ref="ruleForm" class="demo-ruleForm">
          ...
          <el-form-item label="使用门槛：" prop="path">
            <el-input v-model="swiper.path" class="inpud"></el-input>
          </el-form-item>
          <el-form-item label="优惠金额：" prop="path">
            <el-input v-model="swiper.path" class="inpud"></el-input>
          </el-form-item>
          <el-form-item label="开始时间：" prop="path">
            <el-input v-model="swiper.path" class="inpud"></el-input>
          </el-form-item>
          <el-form-item label="结束时间：" prop="path">
            <el-input v-model="swiper.path" class="inpud"></el-input>
          </el-form-item>
          <el-form-item label="发放数量：" prop="path">
            <el-input v-model="swiper.path" class="inpud"></el-input>
          </el-form-item>
        </el-form>
      </div>
    ...
    <div style="margin-top: 20px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="link" label="使用门槛" width="150px">
        </el-table-column>
