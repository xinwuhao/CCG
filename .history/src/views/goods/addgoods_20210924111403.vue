  ...
  <div>
    ...
    <div v-if="judge !== 0">
      <el-tabs v-model="judge">
        <el-tab-pane label="基础设" name="1">User</el-tab-pane>
        <el-tab-pane label="媒体信息" name="2">Config</el-tab-pane>
        <el-tab-pane label="商品规格" name="3">Role</el-tab-pane>
        <el-tab-pane label="商品详情" name="4">Task</el-tab-pane>
      </el-tabs>
    </div>
  </div>
</template>
