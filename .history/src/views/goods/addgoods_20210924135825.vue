      ...
      <el-tabs v-model="judge">
        <el-tab-pane label="基础设" name="1" disabled>
          <el-form :model="swiper" ref="ruleForm" class="demo-ruleForm">
            ...
            <el-form-item label="商品库存" prop="path">
              <el-input v-model="swiper.path" class="inpud"></el-input>
            </el-form-item>
            <el-form-item label="商品简介" prop="path">
              <el-input
            ...
            <el-form-item label="推荐介绍" prop="path">
              <el-input
                v-model="swiper.spec_item"
                :rows="4"
                type="textarea"
            ...
            <el-form-item label="是否新品" prop="path">
              <el-switch
                v-model="swiper.isShow"
                active-color="#13ce66"
                inactive-color="#ff4949"
                @change="chen"
              >
            ...
            <el-form-item label="是否热销" prop="path">
              <el-switch
                v-model="swiper.isShow"
                active-color="#13ce66"
                inactive-color="#ff4949"
            ...
            <el-form-item label="是否推荐" prop="path">
              <el-switch
                v-model="swiper.isShow"
                active-color="#13ce66"
                inactive-color="#ff4949"
          ...
          <div>
            ...
            <el-button type="primary" @click="confirm(swiper)">确定</el-button>
          </div>
        </el-tab-pane>
