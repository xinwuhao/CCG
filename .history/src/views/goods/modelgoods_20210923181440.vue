<template>
  <div>
    <div class="searchBox">
      ...
      <el-button type="primary" @click="ON">添加模型</el-button>
    </div>
    <!-- 添加模型弹出层 -->
    <el-dialog
      title="添加模型"
    ...
    <div style="margin-top: 20px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="name" label="通知内容"> </el-table-column>
        <el-table-column fixed="right" label="操作">
          <template #default="scope">
            <el-button @click="reduce(scope.row)" type="text" size="small"
              >删除</el-button
            >
            <el-button @click="goto(scope.row)" type="text" size="small"
              >添加规格</el-button
            >
