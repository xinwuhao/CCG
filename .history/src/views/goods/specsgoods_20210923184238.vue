  ...
  <div>
    ...
    <div style="margin-top: 20px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="name" label="模型名称" header-align="center">
        </el-table-column>
        <el-table-column prop="name" label="所属模型" header-align="center">
        </el-table-column>
        <el-table-column prop="name" label="展示方式" header-align="center">
        </el-table-column>
        <el-table-column
          prop="name"
          label="规格选项"
