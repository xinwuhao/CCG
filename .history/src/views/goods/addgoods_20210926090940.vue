...
let confirm3 = () => {
  ...
  api.addGoods({
    name: swiper.value, // 商品名称
    category: swiper.value, // 商品分类
    cover: swiper.value, // 封面图
    pic, // 商品图片
    isHot: swiper.value, // 是否热销
    video: [], // 商品视频
    isRecommend: swiper.value, // 是否推荐
    originalPrice: "", // 原价
    presentPrice: swiper.value, // 现价
    discount: [], // 优惠 传空
    detail: discount.value, // 商品详情
    spec: user.value, // 商品规格
    introduction: swiper.value, // 商品简介
    company: swiper.value, // 商品单位
    stock: swiper.value, // 商品库存
    isNewGood: swiper.value, // 是否新品
    comment: swiper.value, // 商品评价
    isShow: swiper.value, // 是否显示
    sellDesc: swiper.value, // 推荐介绍
    productionDesc: [], // 产品介绍
  });
  judge.value = "0";
};
