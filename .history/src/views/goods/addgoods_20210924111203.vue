  ...
  <div>
    ...
    <div v-if="judge !== 0">
      <el-tabs v-model="activeName">
        <el-tab-pane label="基础设" name="first">User</el-tab-pane>
        <el-tab-pane label="媒体信息" name="second">Config</el-tab-pane>
        <el-tab-pane label="商品规格" name="third">Role</el-tab-pane>
        <el-tab-pane label="商品详情" name="fourth">Task</el-tab-pane>
      </el-tabs>
    </div>
  </div>
</template>
