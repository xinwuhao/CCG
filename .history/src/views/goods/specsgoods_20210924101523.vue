  ...
  <div>
    ...
    >
      <div style="margin-top: 10px">
        <el-form :model="swiper" ref="ruleForm" class="demo-ruleForm">
          <el-form-item label="规格名称" prop="content">
            <el-input v-model="swiper.name" class="inpud"></el-input>
          </el-form-item>
          <el-form-item label="所属模型" prop="content">
            <el-select
              v-model="swiper.mode"
              clearable
              filterable
          ...
          <el-form-item label="规格项" prop="spec_item">
            <el-input
              v-model="swiper.spec_item"
              :rows="2"
              type="textarea"
              placeholder="请输入规格一行一个"
            />
          </el-form-item>
          <el-form-item label="展示方式" prop="model">
            <el-radio-group v-model="swiper.model">
    ...
    <div style="margin-top: 20px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="mode" label="所属模型" align="center">
        </el-table-column>
        <el-table-column prop="model" label="展示方式" align="center">
        </el-table-column>
        <el-table-column
          prop="spec_item"
          label="规格选项"
...
let getlong = () => {
  api
    .addSpec({
      ...
      model: swiper.value.model,
      spec_item: swiper.value.spec_item,
      mode: swiper.value.mode,
