  ...
  <div>
    ...
    <div style="margin-top: 20px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="content" label="是否新品"> </el-table-column>
        <el-table-column prop="content" label="是否热卖"> </el-table-column>
        <el-table-column prop="content" label="是否推荐"> </el-table-column>
