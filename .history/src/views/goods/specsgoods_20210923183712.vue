  ...
  <div>
    ...
    <div style="margin-top: 20px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="name" label="所属模型"> </el-table-column>
        <el-table-column prop="name" label="展示方式"> </el-table-column>
        <el-table-column prop="name" label="规格选项" width="300px"> </el-table-column>
