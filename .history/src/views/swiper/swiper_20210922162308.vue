  ...
  <div>
    ...
    <div>
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column fixed prop="date" label="#"> </el-table-column>
        <el-table-column prop="name" label="姓名"> </el-table-column>
        <el-table-column prop="province" label="lij"> </el-table-column>
        <el-table-column prop="city" label="标题"> </el-table-column>
