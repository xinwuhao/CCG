...
let alter = (e: any) => {
  id.value = e._id;
  swiper.value.avatar = e.avatar;
  swiper.value.username = e.username;
  swiper.value.email = e.email;
  swiper.value.mobile = e.mobile;
  swiper.value.password = e.password;
  dialogVisible.value = true;
  num.value = 2;
};
//确定按钮
