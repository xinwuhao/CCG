  ...
  <div>
    ...
    <div style="margin-top: 20px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="name" label="秒杀商品"> </el-table-column>
        ...
        <el-table-column prop="amount" label="秒杀价格" width="150px">
        </el-table-column>
        <el-table-column prop="goods_number" label="秒杀数量" width="150px">
        </el-table-column>
