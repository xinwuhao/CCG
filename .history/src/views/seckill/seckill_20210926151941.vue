  ...
  <div>
    ...
    >
      <div style="margin-top: 10px">
        <el-form :model="swiper" ref="ruleForm" class="demo-ruleForm">
          ...
          <el-form-item label="秒杀价格：" prop="goods_number">
            <el-input v-model="swiper.goods_number" class="inpud"></el-input>
          </el-form-item>
          <el-form-item label="秒杀数量：" prop="price">
            <el-input v-model="swiper.price" class="inpud"></el-input>
          </el-form-item>
        </el-form>
      </div>
      <template #footer>
    ...
    <div style="margin-top: 20px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="goods.name" label="秒杀商品"> </el-table-column>
        ...
        <el-table-column prop="goods_number" label="秒杀价格" width="150px">
        </el-table-column>
        <el-table-column prop="price" label="秒杀数量" width="150px">
        </el-table-column>
...
let alter = (e: any) => {
  id.value = e._id;
  swiper.value.start_time = e.name;
  swiper.value.end_time = e.name;
  swiper.value.goods_number = e.name;
  swiper.value.goods = e.name;
  swiper.value.price = e.name;
  ...
  if (num.value == 1) {
    ...
    api
      .addSeckill({
        ...
        goods_number: swiper.value.goods_number,
        end_time: swiper.value.end_time,
        goods: arr[0],
        price: swiper.value.price,
        isShow: true,
      })
      .then((res: any) => {
        if (res.code == 200) {
