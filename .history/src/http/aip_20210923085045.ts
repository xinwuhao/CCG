...
export default {
  ...
  // 修改用户
  updateUser({ id, username, avatar, email, mobile, status, password }: { password: string, id: string, username: string, avatar: string, email: string, mobile: string, status: boolean }) {
