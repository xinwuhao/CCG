...
export default {
  ...
  // 修改秒杀
  updateSeckill({ start_time, end_time, goods_number, price, goods, isShow }: { price: string, start_time: string, end_time: string, goods_number: string, goods: any, isShow: boolean }) {
