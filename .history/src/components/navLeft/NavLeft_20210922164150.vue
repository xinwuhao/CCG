...
let arr = ref<any>([
  ...
  { name: "轮播图管理", i: "el-icon-help", path: "/swiper" },
  { name: "导航管理", i: "el-icon-data-line", path: "/navigation" },
  { name: "推荐导航", i: "el-icon-document-copy", path: "/recommend" },
  { name: "用户管理", i: "el-icon-user", path: "/user" },
  { name: "商品管理", i: "el-icon-paperclip", path: "" },
...
let arr1 = ref<any>([
  ...
  { name: "商品规格", i: "el-icon-notebook-1", path: "/modelgoods" },
